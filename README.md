...
| **iOS 앱** | SwiftUI 네이티브 앱 — 웹과 동일 백엔드(Railway) 공유. Toss 스타일 디자인으로 실시간 시세·차트·AI 챗·스크리너·매매일지·종목비교·팩트체크·APNs 푸시까지 구현, 소셜 로그인 지원 |
...
- **푸시**: APNs (HTTP/2)
- **모니터링**: Sentry
- **iOS**: SwiftUI 네이티브 앱 (별도 Xcode 프로젝트, 동일 백엔드 공유)
- **배포**: Railway (백엔드/웹)
